...
var enc = binary.BigEndian //определяет кодировку, в которой сохраняем размеры записей и записи индекса

const lenWidth = 8 //определяет количество байтов, используемых для хранения длины записи.
